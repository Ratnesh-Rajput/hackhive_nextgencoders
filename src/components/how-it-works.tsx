    ...
    <section className="container pt-24 px-8">
      ...
      <div className="grid md:grid-cols-3 gap-8 w-full mt-16">
        <div>
          ...
          <div className="py-4 text-center">
            <p>
              ...
              well-lit. Easily upload the image to the FarmVision platform using
        ...
        <div>
          ...
          <div className="py-4 text-center">
            <p>
              FarmVision&apos;s advanced AI technology kicks into action. The
        ...
        <div>
          ...
          <div className="py-4 text-center">
            <p>
              FarmVision provides you with comprehensive insights. It not only
